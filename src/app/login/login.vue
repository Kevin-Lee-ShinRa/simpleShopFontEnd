...
const rules = [
  value => !!value || 'Required.',             // 检查是否填写
  value => (value && value.length >= 3) || 'Min 3 characters'  // 检查最少3个字符
];
      ...
      <v-sheet
        ...
        <v-sheet
            ...
            color="transparent">
                <span
                    class="font-size-28"
                    style="color: rgb(127,0,25)">注册功能未开放，如需注册账号请联系开发人员。</span>
        </v-sheet>
      </v-sheet>
    </v-sheet>
  </v-sheet>
